...
class UnitPay
{
    ...
    private $supportedUnitpayMethods = array('initPayment', 'getPayment', 'massPayment');
    private $requiredUnitpayMethodsParams = array(
        'initPayment' => array('desc', 'account', 'sum'),
        'massPayment' => array('sum', 'purse', 'login', 'transactionId', 'paymentType'),
     ...
     */
    public function api($method, $params = array(), $params2 = [])
    {
        ...
        $requestUrl = $this->apiUrl . '?' . http_build_query(array_merge([
                'method' => $method,
                'params' => $params
            ], $params2), null, '&', PHP_QUERY_RFC3986);
