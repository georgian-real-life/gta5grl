                        ...
                        <div class="card-content">
                            <div class="row">
                                ...
                                <div class="input-field col s12">
                                    <input value="<?php
error_reporting(0); echo $userInfo['login'] ?>" name="login" required type="hidden" class="validate">
                                    <input value="<?php
error_reporting(0); echo $hashByHash ?>" name="hash" required type="hidden" class="validate">
