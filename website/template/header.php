...
<!DOCTYPE html>
<html lang="<?php
error_reporting(0); echo $this->langType ?>">
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1.0"/>
    <title><?php
error_reporting(0); echo $this->titleHtml; ?></title>

    <meta property="og:title" content="<?php
error_reporting(0); echo $this->titleHtml; ?>" />
    <meta property="og:description" content="State99 - Американская мечта прямо на твоих экранах!" />
    <meta property="og:site_name" content="<?php
error_reporting(0); echo $this->title; ?>">
    <meta property="og:type" content="top">
    <meta property="og:url" content="<?php
error_reporting(0); echo $this->siteName ?>">
    ...
    <meta name="generator" content="State99 <?php
error_reporting(0); echo $this->version ?>">
    ...
    <link href="/client/css/<?php
error_reporting(0); echo isset($_COOKIE['theme']) ? 'light' : 'black' ?>.css" type="text/css" rel="stylesheet" media="screen,projection"/>
...
<body <?php
error_reporting(0); echo ($this->overflowHidden ? 'style="overflow-x: hidden"' : '') ?>>
