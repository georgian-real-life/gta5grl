...
<div style="position: absolute; left: 50px; top: 0px; z-index: 100; display: flex;">
    ...
    <a href="/servers" style="margin: 4px" class="btn btn-floating waves-effect wb bw-text z-depth-1"><i class="bw-text material-icons">show_chart</i></a>
    ...
    <div class="card" style="padding: 5px 20px; border-radius: 24px">
        <label>Свободного имущества: <?php
error_reporting(0); echo $gFreeCount; ?> из <?php
error_reporting(0); echo $gAllCount; ?></label>
    </div>
</div>
    ...
    <div class="modal-content">
        ...
        <div class="row">
            <div class="input-field col s6">
                <input id="ot" type="number" name="pfrom" placeholder="От" min="1" value="<?php
error_reporting(0); echo $priceFrom; ?>" class="validate">
            </div>
            <div class="input-field col s6">
                <input id="do" type="number" name="pto" placeholder="До" min="1" value="<?php
error_reporting(0); echo $priceTo; ?>" class="validate">
            </div>
            <div class="col s12">
                <div class="switch">
                    <label>
                        <input name="onlyFree" <?php
error_reporting(0); echo (isset($_GET['onlyFree']) ? 'checked="checked"' : ''); ?> type="checkbox">
    ...
    (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
        (function (global){
            ...
            $(document).ready(function () {
                ...
                map.addControl(new ExitControl({ text: 'Copyright <?php
error_reporting(0); echo date('Y') ?> STATE 99 & GrandTheftAuto.net & gta-5-map.com' }));
