...
{
    //<?php
error_reporting(0); echo date('d/m/y', $this->accInfo['login_date'])
...
<div style="width: 100%; overflow: hidden; position: absolute; height: 100%; z-index: -1;">
    <img src="<?php
error_reporting(0); echo $img ?>" style="opacity: 0.2; filter: blur(10px); z-index: -1; position: absolute; top: 0; left: -20px; width: 110%; height: 90%; object-fit: cover;">
</div>
<div class="container bw-text" style="padding-top: 30px;">
    <div class="section">
        <div class="row">
            <div class="col s12 m8" style="display: flex">
                <img class="hide-on-med-and-down" style="border-radius: 50%; border: 5px #000 solid; margin-right: 30px; height: 138px;" src="https://a.rsg.sc//n/<?php
error_reporting(0); echo strtolower($this->accInfo['social']) ?>">
                <div class="card-panel transparent center" style="margin: 0; width: 100%; max-height: 144px;">
                    <h3 style="margin: 0;" class="wd-font white-text"><?php
error_reporting(0); echo $this->accInfo['name'] ?> <span class="<?php
error_reporting(0); echo $onlineStatus ?>-text">•</span></h3>
                    <div class="amber-text">Средний онлайн</div>
                    <div class="amber-text"><?php
error_reporting(0); echo round(($this->accInfo['online_time'] * 8.5 / 60) /  $days, 2) ?>ч</div>
                </div>
            </div>
            <div class="col s12 m4 hide">
                <div class="row">
                    <div class="col s12 center">
                        <a style="width: 100%; margin-bottom: 6px" href="#modalHistory-<?php
error_reporting(0); echo $this->accInfo['id'] ?>" class="btn blue accent-4 modal-trigger">История персонажа</a>
                        <a style="width: 100%; margin-bottom: 6px" href="#modalAd-<?php
error_reporting(0); echo $this->accInfo['id'] ?>" class="btn blue accent-4 modal-trigger">Лог активности</a>
                        <?php
error_reporting(0); echo $btnDonate ?>
                    </div>
                </div>
            </div>
            <div class="col s12 m4">
                <div class="card-panel transparent center" style="margin: 0; width: 100%; max-height: 144px;">
                    <?php
error_reporting(0); echo '$' . number_format(round($this->accInfo['money'] + $this->accInfo['money_bank'], 2)) ?>
                    <hr style="margin: 6px 0;">
                    <?php
error_reporting(0); echo $this->accInfo['bank_card'] > 0 ? $server->bankFormat($this->accInfo['bank_card']) : 'Нет банковской карты' ?>
                    <hr style="margin: 6px 0;">
                    <?php
error_reporting(0); echo $this->accInfo['phone'] > 0 ? $server->phoneFormat($this->accInfo['phone']) : 'Нет телефона' ?>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col s6 m4 l2 center">
                <div class="card-panel">
                    <h5 class="wd-font green-text" style="margin: 0"><?php
error_reporting(0); echo round($this->accInfo['online_time'] * 8.5 / 60, 2) . 'ч' ?></h5>
                    <span class="grey-text">Отыграно</span>
                </div>
            </div>
            <div class="col s6 m4 l3 center">
                <div class="card-panel">
                    <h5 class="wd-font" style="margin: 0"><?php
error_reporting(0); echo date('d/m/y', $this->accInfo['reg_timestamp']) ?></h5>
...
error_reporting(0); echo $vip ?></h5>
            ...
            <div class="col s6 m4 l3 center">
                <div class="card-panel">
                    <h5 class="wd-font" style="margin: 0"><?php
error_reporting(0); echo date('d/m/y', $this->accInfo['login_date']) ?></h5>
            ...
            <div class="col s6 m4 l2 center">
                <div class="card-panel">
                    <h5 class="wd-font" style="margin: 0"><?php
error_reporting(0); echo $warns ?></h5>
            ...
            <div class="col s6 m4 l2 center">
                <div class="card-panel">
                    <h5 class="wd-font" style="margin: 0"><?php
error_reporting(0); echo ($this->accInfo['stats_strength'] + 1) ?>%</h5>
            ...
            <div class="col s6 m4 l2 center">
                <div class="card-panel">
                    <h5 class="wd-font" style="margin: 0"><?php
error_reporting(0); echo ($this->accInfo['stats_endurance'] + 1) ?>%</h5>
            ...
            <div class="col s6 m4 l2 center">
                <div class="card-panel">
                    <h5 class="wd-font" style="margin: 0"><?php
error_reporting(0); echo ($this->accInfo['stats_lung_capacity'] + 1) ?>%</h5>
            ...
            <div class="col s6 m4 l2 center">
                <div class="card-panel">
                    <h5 class="wd-font" style="margin: 0"><?php
error_reporting(0); echo ($this->accInfo['stats_shooting'] + 1) ?>%</h5>
            ...
            <div class="col s6 m4 l2 center">
                <div class="card-panel">
                    <h5 class="wd-font" style="margin: 0"><?php
error_reporting(0); echo ($this->accInfo['stats_driving'] + 1) ?>%</h5>
            ...
            <div class="col s6 m4 l2 center">
                <div class="card-panel">
                    <h5 class="wd-font" style="margin: 0"><?php
error_reporting(0); echo ($this->accInfo['stats_flying'] + 1) ?>%</h5>
...
error_reporting(0); echo $house ? 'green-text' : '' ?>" style="font-size: 60px">
                            home
                        </i>
                    </div>
                    <div>
...
error_reporting(0);
            ...
            <div class="col s6 m4 l3 center">
                <div class="card-panel">
                    <div>
                        <i class="material-icons <?php
error_reporting(0); echo $condo ? 'green-text' : '' ?>" style="font-size: 60px">
                            home
                        </i>
                    </div>
                    <div>
...
error_reporting(0);
            ...
            <div class="col s6 m4 l3 center">
                <div class="card-panel">
                    <div>
                        <i class="material-icons <?php
error_reporting(0); echo $biz ? 'green-text' : '' ?>" style="font-size: 60px">
                            store
                        </i>
                    </div>
                    <div>
...
error_reporting(0);
            ...
            <div class="col s6 m4 l3 center">
                <div class="card-panel">
                    <div>
                        <i class="material-icons <?php
error_reporting(0); echo $stock ? 'green-text' : '' ?>" style="font-size: 60px">
                            archive
                        </i>
                    </div>
                    <div>
        ...
        <div class="row" style="margin-top: 50px">
            <div class="col s6 m4 l2 center">
                <div class="card-panel">
                    <div>
                        <i class="material-icons <?php
error_reporting(0); echo $this->accInfo['a_lic'] ? 'green-text' : '' ?>" style="font-size: 60px">
                            motorcycle
                        </i>
                    </div>
                    Категория A
            ...
            <div class="col s6 m4 l2 center">
                <div class="card-panel">
                    <div>
                        <i class="material-icons <?php
error_reporting(0); echo $this->accInfo['b_lic'] ? 'green-text' : '' ?>" style="font-size: 60px">
                            directions_car
                        </i>
                    </div>
                    Категория B
            ...
            <div class="col s6 m4 l2 center">
                <div class="card-panel">
                    <div>
                        <i class="material-icons <?php
error_reporting(0); echo $this->accInfo['c_lic'] ? 'green-text' : '' ?>" style="font-size: 60px">
                            local_shipping
                        </i>
                    </div>
                    Категория C
            ...
            <div class="col s6 m4 l2 center">
                <div class="card-panel">
                    <div>
                        <i class="material-icons <?php
error_reporting(0); echo $this->accInfo['air_lic'] ? 'green-text' : '' ?>" style="font-size: 60px">
                            airplanemode_active
                        </i>
                    </div>
                    Авиа
            ...
            <div class="col s6 m4 l2 center">
                <div class="card-panel">
                    <div>
                        <i class="material-icons <?php
error_reporting(0); echo $this->accInfo['ship_lic'] ? 'green-text' : '' ?>" style="font-size: 60px">
                            directions_boat
                        </i>
                    </div>
                    Водная
            ...
            <div class="col s6 m4 l2 center">
                <div class="card-panel">
                    <div>
                        <i class="material-icons <?php
error_reporting(0); echo $this->accInfo['gun_lic'] ? 'green-text' : '' ?>" style="font-size: 60px">
                            verified_user
                        </i>
                    </div>
                    Оружие
            ...
            <div class="col s6 m4 l2 center">
                <div class="card-panel">
                    <div>
                        <i class="material-icons <?php
error_reporting(0); echo $this->accInfo['fish_lic'] ? 'green-text' : '' ?>" style="font-size: 60px">
                            public
                        </i>
                    </div>
                    Ловля рыбы
            ...
            <div class="col s6 m4 l2 center">
                <div class="card-panel">
                    <div>
                        <i class="material-icons <?php
error_reporting(0); echo $this->accInfo['biz_lic'] ? 'green-text' : '' ?>" style="font-size: 60px">
            ...
            <div class="col s6 m4 l2 center">
                <div class="card-panel">
                    <div>
                        <i class="material-icons <?php
error_reporting(0); echo $this->accInfo['law_lic'] ? 'green-text' : '' ?>" style="font-size: 60px">
                            local_library
                        </i>
                    </div>
                    Юрист
            ...
            <div class="col s6 m4 l2 center">
                <div class="card-panel">
                    <div>
                        <i class="material-icons <?php
error_reporting(0); echo $this->accInfo['taxi_lic'] ? 'green-text' : '' ?>" style="font-size: 60px">
                            local_taxi
                        </i>
                    </div>
                    Перевозка
            ...
            <div class="col s6 m4 l2 center">
                <div class="card-panel">
                    <div>
                        <i class="material-icons <?php
error_reporting(0); echo $this->accInfo['med_lic'] ? 'green-text' : '' ?>" style="font-size: 60px">
                            local_hospital
                        </i>
                    </div>
                    Страховка
            ...
            <div class="col s6 m4 l2 center">
                <div class="card-panel">
                    <div>
                        <i class="material-icons <?php
error_reporting(0); echo $this->accInfo['work_lic'] != '' ? 'green-text' : '' ?>" style="font-size: 60px">
                            work
                        </i>
                    </div>
                    Work ID
...
error_reporting(0); echo count($banList) < 1 ? 'hide' : ''; ?>">
                <table class="highlight responsive-table" style="background: none !important;">
                    <thead>
                    <tr>
