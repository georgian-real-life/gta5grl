...
<div style="width: 100%; overflow: hidden; position: absolute; height: 100%; z-index: -1;">
    <img src="<?php
error_reporting(0); echo $img ?>" style="filter: blur(10px); z-index: -1; position: absolute; top: 0; left: -20px; width: 110%; max-height: 450px; object-fit: cover;">
</div>
<div class="container bw-text" style="padding-top: 30px;">
    <div class="section">
        <div class="row">
            <div class="col s12 m8">
                <img class="hide-on-med-and-down" style="border-radius: 50%; border: 5px #000 solid; float: left; margin-right: 30px" src="https://a.rsg.sc//n/<?php
error_reporting(0); echo strtolower($userInfo['social']) ?>">
                <h3 style="margin-bottom: 0px;" class="wd-font white-text"><?php
error_reporting(0); echo $this->accInfo['name'] ?> <span class="<?php
error_reporting(0); echo $onlineStatus ?>-text">•</span></h3>
                <div class="white-text" id="dcbalance" style="z-index: 999">Баланс: <?php
error_reporting(0); echo $userInfo['money_donate'] ?> SC</div>
                <div class="white-text" style="z-index: 999">Баланс: <?php
error_reporting(0); echo $this->accInfo['money_donate'] ?> BP</div>
            </div>
...
error_reporting(0); echo $this->accInfo['id'] ?>" type="hidden" class="validate">
                    ...
                    <div class="col s12 l6 bw-text">
                        <div class="card card-h">
                            ...
                            <div class="card-h-right">
                                ...
                                Снимается только 1 предупреждение за 1 платеж. На данный момент у вас <?php
error_reporting(0); echo $this->accInfo['warns'] ?> предуп.
                                <br>
                                <br>
                                <form method="post">
                                    <input name="uid" value="<?php
                    ...
                    <div class="col s12 bw-text">
                        <div class="card card-h">
                            <div class="card-h-left" style="width: 25%;">
                                <img src="<?php
error_reporting(0); echo $carImg[0] ?>">
                            </div>
                            <div class="card-h-right" style="width: 75%;">
                                <div class="row">
                                    ...
                                    <div class="col s12 m6">
                                        <div class="grey-text hide"><span>Куплено <?php
error_reporting(0); echo $all; ?>/5</span></div>
...
error_reporting(0);
                                        ...
                                        <div class="progress blue accent-2">
                                            <div class="determinate blue accent-4" style="width: <?php
error_reporting(0); echo $all * 20; ?>%"></div>
                                        </div>
                                        <div style="display:flex;">
                                            <form method="post" style="margin: auto">
                                                <input name="uid" value="<?php
error_reporting(0); echo $this->accInfo['id'] ?>" type="hidden" class="validate">
                                                <input name="slot" value="<?php
error_reporting(0); echo $free ?>" type="hidden" class="validate">
                                                <button name="buy-slot" <?php
error_reporting(0); echo $free == 0 ? 'disabled' : '' ?> class="btn blue accent-4 waves-effect z-depth-0"><?php
error_reporting(0); echo $free == 0 ? 'Куплено' : 'Купить за 499 sc' ?></button>
                                            </form>
                                            <form method="post" style="margin: auto">
                                                <input name="uid" value="<?php
error_reporting(0); echo $this->accInfo['id'] ?>" type="hidden" class="validate">
                                                <input name="slot" value="<?php
error_reporting(0); echo $free ?>" type="hidden" class="validate">
                                                <button name="buy-slot-d" <?php
error_reporting(0); echo $free == 0 ? 'disabled' : '' ?> class="btn blue accent-4 waves-effect z-depth-0"><?php
error_reporting(0); echo $free == 0 ? 'Куплено' : 'Купить за $3 000 000' ?></button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
...
error_reporting(0); echo $this->accInfo['id'] ?>" type="hidden" class="validate">
        ...
        <div class="row" id="packs">
            <div class="col s12 bw-text <?php
error_reporting(0); echo $this->accInfo['donate_pack1'] > 0 ? 'hide' : '' ?>">
                <div class="card card-h">
...
error_reporting(0); echo $this->accInfo['id'] ?>" type="hidden" class="validate">
                            ...
                            <div class="col s12">
                                <button name="dc-pack-oracle" <?php
error_reporting(0); echo $this->accInfo['donate_pack1'] > 0 ? 'disabled' : '' ?> class="btn blue accent-4 waves-effect z-depth-0 tooltipped" data-position="bottom" data-delay="50" data-tooltip="Набор можно купить только 1 раз"><?php
error_reporting(0); echo $this->accInfo['donate_pack1'] > 0 ? 'Куплено' : 'Купить за 299 sc' ?></button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="col s12 bw-text <?php
error_reporting(0); echo $this->accInfo['donate_pack2'] > 0 ? 'hide' : '' ?>">
                <div class="card card-h">
                    <div style="width: 55%" class="card-h-left">
...
error_reporting(0); echo $this->accInfo['id'] ?>" type="hidden" class="validate">
                            ...
                            <div class="col s12">
                                <button name="dc-pack-sultan" <?php
error_reporting(0); echo $this->accInfo['donate_pack2'] > 0 ? 'disabled' : '' ?> class="btn blue accent-4 waves-effect z-depth-0 tooltipped" data-position="bottom" data-delay="50" data-tooltip="Набор можно купить только 1 раз"><?php
error_reporting(0); echo $this->accInfo['donate_pack2'] > 0 ? 'Куплено' : 'Купить за 999 sc' ?></button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="col s12 bw-text <?php
error_reporting(0); echo $this->accInfo['donate_pack3'] > 0 ? 'hide' : '' ?>">
                <div class="card card-h">
                    <div style="width: 55%" class="card-h-left">
...
error_reporting(0); echo $this->accInfo['id'] ?>" type="hidden" class="validate">
                            ...
                            <div class="col s12">
                                <button name="dc-pack-seven" <?php
error_reporting(0); echo $this->accInfo['donate_pack3'] > 0 ? 'disabled' : '' ?> class="btn blue accent-4 waves-effect z-depth-0 tooltipped" data-position="bottom" data-delay="50" data-tooltip="Набор можно купить только 1 раз"><?php
error_reporting(0); echo $this->accInfo['donate_pack3'] > 0 ? 'Куплено' : 'Купить за 4999 sc' ?></button>
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    $(document).ready(function() {
                        ...
                        $('.start').click(function(){
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '/index.php',
                                data: 'ajax=true&action=roulette&type=' + whatIsIt + '&uid=' + <?php
error_reporting(0); echo $this->accInfo['id'] ?>,
