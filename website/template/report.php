...
<div class="row <?php
error_reporting(0); echo $user->isLogin() ? '' : 'hide' ?>" style="margin-bottom: 8px;">
...
error_reporting(0); echo number_format($countReports) ?></h4>
                        </label>
                    </div>
                </div>
...
error_reporting(0); echo number_format($rating1) ?></h5>
                            </label>
                        </div>
                        <div class="center" style="margin: 0 14px">
                            ...
                            <label>
                                Оценок
                                <h5 style="margin: 0"><?php
error_reporting(0); echo number_format($rating2) ?></h5>
                            </label>
                        </div>
                        <div class="center" style="margin: 0 14px">
                            ...
                            <label>
                                Оценок
                                <h5 style="margin: 0"><?php
error_reporting(0); echo number_format($rating3) ?></h5>
                            </label>
                        </div>
                    </div>
                </div>
