...
error_reporting(0);
            ...
            var options = {
                chart: {
                    ...
                    subtitle: 'Всего регистраций: <?php
error_reporting(0); echo number_format($userCountList) ?>'
                },
                height: 300,
                axes: {
                    x: {
...
<div class="container">
    <div class="section">
        <div class="row">
            <div class="col s12">
                <h4 class="grey-text wd-font">Статистика сервера <?php
error_reporting(0); echo $serverName; ?></h4>
                <label>Игровое время: <?php
error_reporting(0); echo $dateTimeSrv['hour'] . ':' . $dateTimeSrv['minute'] . ' ' . $dateTimeSrv['day'] . '/' . $dateTimeSrv['month'] . '/' . $dateTimeSrv['year'] ?></label>
            </div>
            <div class="col s12">
    ...
    <div class="section">
        <div class="section">
            <div class="row">
                <div class="row hide">
                    <div class="col s12">
                        <h4 class="grey-text center">Статистика сервера <?php
error_reporting(0); echo $serverName; ?>
                            <br><label>Зарегестрированно игроков: <?php
error_reporting(0); echo $userCountList ?></label></h4>
                    </div>
                </div>
                <div class="row hide">
                    <div class="col s12 m4">
                        <div class="icon-block">
                            ...
                            <h4 class="center bw-text">$<?php
error_reporting(0); echo number_format($monitoringList['statistic']['money']) ?></h4>
                        </div>
                    </div>
                    <div class="col s12 m4">
                        <div class="icon-block">
                            ...
                            <h4 class="center bw-text">$<?php
error_reporting(0); echo number_format($monitoringList['statistic']['moneyFull']) ?></h4>
                        </div>
                    </div>
                    ...
                    <div class="col s12 m4">
                        <div class="icon-block">
                            ...
                            <h4 class="center bw-text">$<?php
error_reporting(0); echo number_format($monitoringList['statistic']['moneyFree']) ?></h4>
                        </div>
                    </div>
                </div>
...
error_reporting(0);
                ...
                <div class="col s12" id="top">
                    <?php
error_reporting(0); $tmp->showBlockPage('top'); ?>
                </div>
