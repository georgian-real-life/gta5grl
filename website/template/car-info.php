...
error_reporting(0); echo $userInfo['admin_level'] > 0 ? '' : 'hide' ?>">Всего на авторынке: <?php
error_reporting(0); echo $carCount ?></h4>
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col s12">
                                <div class="card z-depth-0">
                                    <img alt="<?php
error_reporting(0); echo $carInfo['m_name'] . ' ' . $carInfo['n_name']; ?>" src="/client/images/carsv/1080/<?php
error_reporting(0); echo strtolower($this->carName); ?>.jpg" class="materialboxed" style="width: 100%; object-fit: cover;">
                                </div>
                            </div>
                        </div>
                    </div>
