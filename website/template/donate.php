            ...
            <div class="col s12 l4 bw-text">
                ...
                <div class="card card-h">
                    ...
                    <div class="card-h-right">
                        <h5 class="wd-font bw-text text-accent-4">Баланс: <?php
error_reporting(0); echo $userInfo['money_donate'] ?> sc</h5>
                        <form action="https://unitpay.ru/pay/357791-f8bce" class="row" style="margin-bottom: 0">
                            <div class="input-field col s12">
                                <input id="donateAcc" type="hidden" name="account" value="1|<?php
error_reporting(0); echo $userInfo['id'] ?>">
                                <input id="donateDesc" type="hidden" name="desc" value="Пополнение SCoin на акканут: <?php
error_reporting(0); echo $userInfo['login'] ?>">
