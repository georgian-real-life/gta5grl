            ...
            <div class="row">
                ...
                <div class="col s12 m6 l4 center hide">
                    <div class="switch">
                        <label>
                            Night
                            <input onchange="$.enableLightTheme(this.checked)" <?php
error_reporting(0); echo isset($_COOKIE['theme']) ? 'checked' : '' ?> name="changeside" type="checkbox">
                            <span class="lever"></span>
                            Day
                        </label>
                    </div>
                </div>
                <div class="col s12 m6 l4"><a class="grey-text right" href="https://vk.com/gtav.state">Copyright © <?php
error_reporting(0); echo date('Y') ?> State99 Team</a></div>
