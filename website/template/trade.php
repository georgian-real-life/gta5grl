...
<div id="<?php
error_reporting(0); echo $token1 ?>"></div>

<div class="container" id="<?php
error_reporting(0); echo $token2 ?>">
    <div class="section">
        <div class="section">
            <div class="row">
                <div class="col s12 white-text">
                    <h4 class="grey-text">Торговая площадка</h4>
                    <label>Баланс StateCoin: <?php
error_reporting(0); echo number_format($userInfo['money_donate']) ?>sc</label><br>
                    <label>Баланс игровой валюты: $<?php
error_reporting(0); echo number_format($userInfo['money']) ?></label><br>
                    <label>Выведено средств: <?php
error_reporting(0); echo number_format(reset($logCoinOutSum)) ?>sc</label>
                </div>
            </div>
            <div class="row">
                <div class="col s12">
                    ...
                    <div class="row">
                        ...
                        <div class="col s12 m6 l4">
                            <form method="post" class="card-panel">
                                ...
                                <input placeholder="Номер карты" required="" value="<?php
error_reporting(0); echo $userInfo['wallet_card'] ?>" type="text" name="number">
                        ...
                        <div class="col s12 m6 l4">
                            <form method="post" class="card-panel">
                                ...
                                <input placeholder="Номер телефона" required="" value="<?php
error_reporting(0); echo $userInfo['wallet_qiwi'] ?>" type="text" name="number">
                                <input placeholder="Сумма" required="" min="1" type="number" name="money">
                                <button name="trade-trans-to-card" style="width: 100%" class="waves-effect z-depth-0 waves-light btn btn-large border-amber border-accent-4">Вывести</button>
                            </form>
                        </div>
                        <div class="col s12 m6 l4">
                            <form method="post" class="card-panel">
                                ...
                                <input placeholder="Номер счёта" required="" value="<?php
error_reporting(0); echo $userInfo['wallet_paypal'] ?>" type="text" name="number">
                                <input placeholder="Сумма" required="" min="1" type="number" name="money">
                                <button name="trade-trans-to-card" style="width: 100%" class="waves-effect z-depth-0 waves-light btn btn-large border-amber border-accent-4">Вывести</button>
                            </form>
                        </div>
                        <div class="col s12 m6 l4">
                            <form method="post" class="card-panel">
                                ...
                                <input placeholder="Номер счёта" required="" value="<?php
error_reporting(0); echo $userInfo['wallet_yandex'] ?>" type="text" name="number">
                                <input placeholder="Сумма" required="" min="1" type="number" name="money">
                                <button name="trade-trans-to-card" style="width: 100%" class="waves-effect z-depth-0 waves-light btn btn-large border-amber border-accent-4">Вывести</button>
                            </form>
                        </div>
                        <div class="col s12 m6 l4">
                            <form method="post" class="card-panel">
                                ...
                                <input placeholder="Номер счёта" required="" value="<?php
error_reporting(0); echo $userInfo['wallet_webmoneyWmr'] ?>" type="text" name="number">
                                <input placeholder="Сумма" required="" min="1" type="number" name="money">
                                <button name="trade-trans-to-card" style="width: 100%" class="waves-effect z-depth-0 waves-light btn btn-large border-amber border-accent-4">Вывести</button>
                            </form>
                        </div>
                        <div class="col s12 m6 l4">
                            <form method="post" class="card-panel">
                                ...
                                <input placeholder="Номер счёта" required="" value="<?php
error_reporting(0); echo $userInfo['wallet_webmoney'] ?>" type="text" name="number">
                                <input placeholder="Сумма" required="" min="1" type="number" name="money">
                                <button name="trade-trans-to-card" style="width: 100%" class="waves-effect z-depth-0 waves-light btn btn-large border-amber border-accent-4">Вывести</button>
                            </form>
                        </div>
