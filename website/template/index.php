...
error_reporting(0); echo $srv1Online['ip'] ?></div>
                            <div class="grey-text"><?php
error_reporting(0); echo $srv1Online['online'] ?>/<?php
error_reporting(0); echo $srv1Online['max_online'] ?></div>
                        </div>
                        <div class="determinate grey darken-3" style="width: <?php
error_reporting(0); echo $srv1Procent ?>%;"></div>
                    </div>
                    <div class="grey-text card-panel hide" style="padding-top: 0"><a class="grey-text" href="/servers"><?php
error_reporting(0); echo $srv1Online['ip'] ?></a></div>
                </div>
            </div>
            <div class="col s12 m4">
                <div class="center">
...
error_reporting(0); echo $srv1Procent ?>%;"></div>
                    ...
                    <div class="grey-text card-panel hide" style="padding-top: 0"><a class="grey-text" href="/banlist"><?php
error_reporting(0); echo $srv1Online['ip'] ?></a></div>
                </div>
            </div>
            <div class="col s12 m4">
