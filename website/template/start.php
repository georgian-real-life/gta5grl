...
<div>
    <div class="container">
        <div class="section bw-text">
            <div class="row">
                ...
                <div class="col s12 l4">
                    <h4 class="wd-font">Шаг 3</h4>
                    <div class="card">
                        <div class="card-image">
                            <a href="https://discord.gg/84VerfZBGT"><img style="height: 200px; object-fit: cover;" src="https://i.imgur.com/F7ATzP1.png"></a>
                        </div>
                        <div class="card-content">
                            <p>Выбери свой путь и наслаждайся игрой, стань настоящим хакером или кем ты там еще хочешь? Удачи тебе бро или систер</p>
                        </div>
                        <div class="card-action">
                            <a target="_blank" href="rage://v/connect?ip=51.83.236.106:22005" class="btn z-depth-0 green-text wd-font">Подключиться</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <li>
                            ...
                            <div class="collapsible-body">
                                <p>
                                    ...
                                    <br><br>
                                    <a href="https://gta5.arizona-rp.com/"><label>Источник</label></a>
                                </p>
                            </div>
                        </li>
                        <li>
    ...
    <div class="container">
        <div class="section">
            <div class="row">
                <div class="col s12">
                    <h4 class="bw-text wd-font">Системные требования</h4>
                </div>
                <div class="col s12 l6">
                    <div class="card">
                        <div class="card-content">
                            <h5>Минимальные</h5>
                            <hr>
                            <div class="grey-text">Операционная система: <div class="right bw-text">Windows 7 64 Bit и выше</div></div>
                            <hr>
                            <div class="grey-text">Процессор: <div class="right bw-text">Intel Core 2 Q6600 / AMD Phenom 9850</div></div>
                            <hr>
                            <div class="grey-text">Оперативная память: <div class="right bw-text">4GB</div></div>
                            <hr>
                            <div class="grey-text">Видеокарта: <div class="right bw-text">NVIDIA 9800 GT 1GB / AMD HD 4870 1GB</div></div>
                            <hr>
                            <div class="grey-text">Звуковая карта: <div class="right bw-text">Совместимая с DirectX 10</div></div>
                            <hr>
                            <div class="grey-text">Место на жестком диске: <div class="right bw-text">90GB</div></div>
                        </div>
                    </div>
                </div>
                <div class="col s12 l6">
                    <div class="card">
                        <div class="card-content">
                            ...
                            <div class="grey-text">Операционная система: <div class="right bw-text">Windows 7 64 Bit и выше</div></div>
                            <hr>
                            <div class="grey-text">Процессор: <div class="right bw-text">Intel Core i5 3470 / AMD X8 FX-8350</div></div>
                            <hr>
                            <div class="grey-text">Оперативная память: <div class="right bw-text">8GB</div></div>
                            <hr>
                            <div class="grey-text">Видеокарта: <div class="right bw-text"> NVIDIA GTX 660 2GB / AMD HD7870 2GB</div></div>
                            <hr>
                            <div class="grey-text">Звуковая карта: <div class="right bw-text">Совместимая с DirectX 10</div></div>
                            <hr>
                            <div class="grey-text">Место на жестком диске: <div class="right bw-text">90GB</div></div>
