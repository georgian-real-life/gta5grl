    ...
    <div class="section">
        <div class="row" style="margin-top: 20px">
            <div class="col s12 m6 l7 white-text">
                ...
                <div><label style="color: rgba(255,2552,255,0.7)">Губернатор:</label> <?php
        ...
        <div class="row" style="margin-top: 140px">
            <div class="col s12 m3">
                <div class="center">
                    ...
                    <h5 class="center"><?php
error_reporting(0); echo $coffer['tax_pay_day']; ?>%</h5>
                </div>
            </div>
            <div class="col s12 m3">
                <div class="center">
                    ...
                    <h5 class="center"><?php
error_reporting(0); echo $coffer['tax_business']; ?>%</h5>
                </div>
            </div>
            <div class="col s12 m3">
                <div class="center">
                    ...
                    <h5 class="center"><?php
error_reporting(0); echo $coffer['tax_property']; ?>%</h5>
                </div>
            </div>
            <div class="col s12 m3">
                <div class="center">
                    ...
                    <h5 class="center">$<?php
error_reporting(0); echo $coffer['benefit']; ?></h5>
                </div>
            </div>
        </div>
    </div>
