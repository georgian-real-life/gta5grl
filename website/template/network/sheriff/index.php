...
$coffer = $qb->createQueryBuilder('official_bank')->selectSql()->where('id = 4')->limit(1)->executeQuery()->getSingleResult();
        ...
        echo '
            <div class="container">
                <div class="section">
                    <div class="row">
                        <div class="col s12">
                            <img style="width: 100%; border-radius: 12px; object-fit: contain;" src="' . htmlspecialchars_decode($item['img']) . '">
                        </div>
...
<img src="https://gtapolicemods.com/uploads/monthly_2019_09/large.20190908215818_1.jpg.43ea3b8a6edb08e9c1107413f3e3a3e9.jpg" style="position: absolute; z-index: -1; width: 100%; height: 400px; object-fit: cover;">
    ...
    <div class="section">
        <div class="row" style="margin-top: 20px">
            <div class="col s12 m6 l7 white-text">
                ...
                <h3>Официальный сайт BCSD</h3>
                <div><label style="color: rgba(255,2552,255,0.7)">Начальник департамента:</label> <?php
error_reporting(0); echo $leaderName; ?></div>
            </div>
            <div class="col s12 m6 l5">
                <div class="center" style="margin-top: 80px">
                    ...
                    <h3 class="center white-text">$<?php
error_reporting(0); echo number_format($coffer['money']); ?></h3>
                </div>
            </div>
        </div>
    </div>
...
error_reporting(0);
            ...
            if((($user->isLeader() && $user->isSheriff()) || $user->isAdmin(5)) && $user->isLogin())
            {
                echo '
                ...
                echo '
                        <div class="row" style="margin-top: 80px">
                            <div class="col s12 l4">
                                <a href="/network/sheriff?newsId=' . $item['id'] . '"><img loading="lazy" style="width: 100%; border-radius: 12px; object-fit: contain;" src="' . htmlspecialchars_decode($item['img']) . '"></a>
                            </div>
                            <div class="col s12 l8">
                                <div class="black-text">
                                    <label style="font-size: 2rem; font-weight: 300" class="grey-text text-darken-3"><a class="grey-text text-darken-3" href="/network/sheriff?newsId=' . $item['id'] . '">' . htmlspecialchars_decode($item['title']) . '</a></label>';
                if($user->isLeader() && $user->isSheriff() || $user->isAdmin(2))
                {
