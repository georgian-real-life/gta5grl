...
$logo = 'https://www.clker.com/cliparts/z/P/K/V/Q/E/paramedic-logo-simple-hi.png';
$bDesc = 'Добро пожаловать на официальный сайт EMS департамента штата San Andreas!';
$bTitle = $bName;
$bImg = $logo;
...
<nav class="red" role="navigation">
    <div class="nav-wrapper container">
        <a id="logo-container" href="/network/ems" class="brand-logo hide-on-med-and-down" style="">
            <img src="<?php
error_reporting(0); echo $logo ?>" class="logo" style="margin: 7px; height: 50px; float: left; filter: none; width: auto;">
        </a>

        <ul class="right hide-on-med-and-down">
            <li><a class="white-text" href="/network/ems">Главная</a></li>
            <li><a class="white-text" href="/network/gov/rules">Кодексы и законы</a></li>
            <?php
error_reporting(0);
            if($user->isLogin()) {
                if (($user->isLeader() || $user->isSubLeader()) && $user->isEms() || $user->isAdmin()) {
                    echo '<li><a class="white-text" href="/network/ems/log">Лог действий</a></li>';
                    echo '<li><a class="white-text" href="/network/ems/info">Информация</a></li>';
                }

                echo '<li><a class="white-text" href="/network/ems/users">Сотрудники</a></li>';
            }
            else
...
error_reporting(0); echo $logo ?>"></a>
            ...
            <li><a href="/network/ems">Главная</a></li>
            <li><a href="/network/gov/rules">Кодексы и законы</a></li>
            <?php
error_reporting(0);
            if($user->isLogin()) {
                if ($user->isLeader() && $user->isEms() || $user->isAdmin())
                    echo '<li><a href="/network/ems/log">Лог действий</a></li>';
            }
            else
