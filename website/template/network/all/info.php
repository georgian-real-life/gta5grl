                    ...
                    <div class="col s12">
                        <form>
                            <div class="card-panel input-field" style=" padding: 0;">
                                <input style="padding-left: 14px; border: none;" id="search" class="search_all" type="search" value="<?php
error_reporting(0); echo $_GET['q'] ?>" placeholder="Поиск" name="q" required="">
                            </div>
                        </form>
                    </div>
                    <div class="col s12">
                            ...
                            <div class="col s12 l4">
                                <table class="highlight transparent">
                                    ...
                                    <tr>
                                        <td>CardID</td>
                                        <td><?php
error_reporting(0); echo $searchInfo['id']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Имя</td>
                                        <td><?php
error_reporting(0); echo $searchInfo['name']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Возраст</td>
                                        <td><?php
error_reporting(0); echo $searchInfo['age']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Банковская карта</td>
                                        <td><?php
error_reporting(0); echo $bankCard; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Телефон</td>
                                        <td><?php
error_reporting(0); echo $phone; ?></td>
                                    </tr>
                                    <?php
error_reporting(0);
                            ...
                            <div class="col s12 l4">
                                <table class="highlight transparent">
                                    ...
                                    <tr>
                                        <td>Лицензия A</td>
                                        <td><?php
error_reporting(0); echo $aLic; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Лицензия B</td>
                                        <td><?php
error_reporting(0); echo $bLic; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Лицензия C</td>
                                        <td><?php
error_reporting(0); echo $cLic; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Лицензия пилота</td>
                                        <td><?php
error_reporting(0); echo $airLic; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Лицензия на водный ТС</td>
                                        <td><?php
error_reporting(0); echo $shipLic; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Лицензия таксиста</td>
                                        <td><?php
error_reporting(0); echo $taxiLic; ?></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                            <div class="col s12 l4">
                                <table class="highlight transparent">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php
error_reporting(0); echo $lawLic; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Лицензия на оружие</td>
                                        <td><?php
error_reporting(0); echo $gunLic; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Лицензия на бизнес</td>
                                        <td><?php
error_reporting(0); echo $bizzLic; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Лицензия на рыбалку</td>
                                        <td><?php
error_reporting(0); echo $fishLic; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Мед. страховка</td>
                                        <td><?php
error_reporting(0); echo $medLic; ?></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
