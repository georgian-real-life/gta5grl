        ...
        <div class="row">
            ...
            <div class="col s12 l4">
                <div class="center" style="margin-top: 30px">
                    ...
                    <h3 class="center black-text">$<?php
error_reporting(0); echo number_format($countLastMonth); ?></h3>
                </div>
            </div>
            <div class="col s12 l4">
                <div class="center" style="margin-top: 30px">
                    ...
                    <h3 class="center black-text">$<?php
error_reporting(0); echo number_format($countLastWeek); ?></h3>
                </div>
            </div>
            <div class="col s12 l4">
                <div class="center" style="margin-top: 30px">
                    ...
                    <h3 class="center black-text">$<?php
error_reporting(0); echo number_format($countLastDay); ?></h3>
                </div>
            </div>
            <div class="col s12">
