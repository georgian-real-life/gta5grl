...
$logo = 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b3/Seal_of_the_United_States_Marine_Corps.svg/1012px-Seal_of_the_United_States_Marine_Corps.svg.png';
$bDesc = 'Добро пожаловать на официальный сайт USMC!';
$bTitle = $bName;
$bImg = $logo;
...
<nav class="blue-grey darken-2" role="navigation">
    <div class="nav-wrapper container">
        <a id="logo-container" href="/network/usmc" class="brand-logo hide-on-med-and-down" style="">
            <img src="<?php
error_reporting(0); echo $logo ?>" class="logo" style="margin: 7px; height: 50px; float: left; filter: none; width: auto;">
        </a>

        <ul class="right hide-on-med-and-down">
            <li><a class="white-text" href="/network/usmc">Главная</a></li>
            <li><a class="white-text" href="/network/gov/rules">Кодексы и законы</a></li>
            <?php
error_reporting(0);
            if($user->isLogin()) {
                if (($user->isLeader() || $user->isSubLeader()) && $user->isUsmc() || $user->isAdmin())
                    echo '<li><a class="white-text" href="/network/usmc/log">Лог действий</a></li>';

                echo '<li><a class="white-text" href="/network/usmc/users">Сотрудники</a></li>';
                echo '<li><a class="white-text" href="/network/usmc/info">Информация</a></li>';
            }
            else
...
error_reporting(0); echo $logo ?>"></a>
            ...
            <li><a href="/network/usmc">Главная</a></li>
            <li><a href="/network/gov/rules">Кодексы и законы</a></li>
            <?php
error_reporting(0);
            if($user->isLogin()) {
                if ($user->isLeader() && $user->isUsmc() || $user->isAdmin())
                    echo '<li><a href="/network/usmc/log">Лог действий</a></li>';
            }
            else
