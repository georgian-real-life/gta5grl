...
$coffer = $qb->createQueryBuilder('official_bank')->selectSql()->where('id = 7')->limit(1)->executeQuery()->getSingleResult();
        ...
        echo '
            <div class="container">
                <div class="section">
                    <div class="row">
                        <div class="col s12">
                            <a href="/network/usmc?newsId=' . $item['id'] . '"><img loading="lazy" style="width: 100%; border-radius: 12px; object-fit: contain;" src="' . htmlspecialchars_decode($item['img']) . '"></a>
                        </div>
...
<img src="https://genapilot.ru/wp-content/uploads/2018/07/grand-theft-auto-v-warfare-2.jpg" style="position: absolute; z-index: -1; width: 100%; height: 400px; object-fit: cover;">
    ...
    <div class="section">
        <div class="row" style="margin-top: 20px">
            <div class="col s12 m6 l7 white-text">
                ...
                <h3>Официальный сайт USMC</h3>
                <div><label style="color: rgba(255,2552,255,0.7)">Генерал:</label> <?php
...
error_reporting(0);
            ...
            if((($user->isLeader() && $user->isUsmc()) || $user->isAdmin(5)) && $user->isLogin())
            {
                echo '
                ...
                echo '
                        <div class="row" style="margin-top: 80px">
                            ...
                            <div class="col s12 l8">
                                <div class="black-text">
                                    <label style="font-size: 2rem; font-weight: 300" class="grey-text text-darken-3"><a class="grey-text text-darken-3" href="/network/usmc?newsId=' . $item['id'] . '">' . htmlspecialchars_decode($item['title']) . '</a></label>';
                if($user->isLeader() && $user->isUsmc() || $user->isAdmin(2))
                {
