...
$coffer = $qb->createQueryBuilder('official_bank')->selectSql()->where('id = 3')->limit(1)->executeQuery()->getSingleResult();
        ...
        echo '
            <div class="container">
                <div class="section">
                    <div class="row">
                        <div class="col s12">
                            <a href="/network/lspd?newsId=' . $item['id'] . '"><img loading="lazy" style="width: 100%; border-radius: 12px; object-fit: contain;" src="' . htmlspecialchars_decode($item['img']) . '"></a>
                        </div>
...
<img src="https://img.gta5-mods.com/q75/images/police-force/3b509f-2017-07-23%20(54).png" style="position: absolute; z-index: -1; width: 100%; height: 400px; object-fit: cover;">
...
error_reporting(0);
            ...
            if((($user->isLeader() && $user->isLspd()) || $user->isAdmin(5)) && $user->isLogin())
            {
                echo '
                ...
                echo '
                        <div class="row" style="margin-top: 80px">
                            ...
                            <div class="col s12 l8">
                                <div class="black-text">
                                    <label style="font-size: 2rem; font-weight: 300" class="grey-text text-darken-3"><a class="grey-text text-darken-3" href="/network/lspd?newsId=' . $item['id'] . '">' . htmlspecialchars_decode($item['title']) . '</a></label>';
                if($user->isLeader() && $user->isLspd() || $user->isAdmin(2))
                {
