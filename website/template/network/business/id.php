    ...
    <div class="section">
        <div class="row" style="margin-top: 20px">
            <div class="col s12 m6 l7 white-text">
                ...
                <h3><?php
error_reporting(0); echo $business['name'] ?></h3>
                <div><label style="color: rgba(255,2552,255,0.7)">Владелец:</label> <?php
...
error_reporting(0); echo number_format($business['price']); ?></h3>
                </div>
            </div>
        </div>
    </div>
