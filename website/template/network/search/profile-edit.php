        ...
        <div class="row">
            <div class="col s12 l3 hide-on-med-and-down">
                ...
                <div class="card-panel collection" style="border: 0; padding: 0;">
                    ...
                    <a href="/rp/mail/in" class="blue-text collection-item">Входящие <?php
error_reporting(0); echo ($unReadCount > 0 ? '<span class="new badge blue">' . $unReadCount . '</span>' : '') ?></a>
...
error_reporting(0); echo $userInfo['rp_name']; ?></h4><label>(( Информация должна быть IC | ФОТОГРАФИИ ИЗ РЕАЛЬНОЙ ЖИЗНИ ЗАПРЕЩЕНЫ ))<br>(( Любые арты, рисунки и фотографии из игры - разрешены. ))</label>
                </div>
                <?php
error_reporting(0);
                echo '
