...
error_reporting(0);
            foreach ($user->getPlayers() as $player) {
                ...
                <div class="row">
                    <div class="col s12">
                        <div style="width: 100%;">
                            <h4 class="bw-text wd-font">Личные качества <a target="_blank" href="/network/news/bio?user=<?php
error_reporting(0); echo $player['name'] ?>" class="btn grey right">Посмотреть биографию</a></h4><label class="hide">(( Информация должна быть IC | ФОТОГРАФИИ ИЗ РЕАЛЬНОЙ ЖИЗНИ ЗАПРЕЩЕНЫ ))<br>(( Любые арты, рисунки и фотографии из игры - разрешены. ))</label>
                        </div>
                        <?php
error_reporting(0);
                        echo '
...
error_reporting(0);
                ...
                ';
                    ...
                    <script>CKEDITOR.replace( "textarea<?php
error_reporting(0); echo $player['id'] ?>" );</script>
                </div>
