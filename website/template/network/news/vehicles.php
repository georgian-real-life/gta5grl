...
error_reporting(0);
                ...
                $vInfo = $qb
                    ...
                    ->selectSql('display_name, price, class_name, class_name_ru')
                        ...
                        <div class="col s12 l3">
                            <div class="card" style="border: 1px #efefef solid">
                                <div class="card-image">
                                    <a target="_blank" href="/network/news/vehicle-' . $item['display_name'] . '"><img alt="' . $item['display_name'] . '" loading="lazy" src="/client/images/carsv/640/' . strtolower($item['display_name']) . '.jpg" style="height: 200px; object-fit: cover;">
                                    <span class="card-title">' . $item['display_name'] . '</span></a>
                                </div>
                                <div class="card-action">
                                    <a target="_blank" href="/network/news/vehicle-' . $item['display_name'] . '" class="bw-text btn z-depth-0">$' . number_format($item['price']) . '</a>
                                    <a target="_blank" href="/network/news/vehicle-' . $item['display_name'] . '" class="bw-text btn z-depth-0 right">' . $countVeh . '/' . $countAll . ' шт.</a>
                                </div>
                            </div>
                        </div>
                        ';
