    ...
    <div class="section">
        <div class="row">
            <div class="col s12 l8">
                <h5 class="wd-font bw-text">Жалоба #<?php
error_reporting(0); echo $report['id'] ?></h5>
                <div class="card-panel" style="overflow: hidden;">
                    <table>
                        ...
                        <tr>
                            <td>Отправитель</td>
                            <td><?php
error_reporting(0); echo $userSender['login'] ?> (<?php
error_reporting(0); echo $userSender['id'] ?>)</td>
                        </tr>
                        <tr class="<?php
error_reporting(0); echo $report['datetime'] == 'SS' ? 'hide' : '' ?>">
                            <td>Нарушители</td>
                            <td><?php
error_reporting(0); echo $targetString ?></td>
                        </tr>
                        <tr>
                            <td>Доказательства</td>
                            <td><?php
error_reporting(0); echo $links ?></td>
                        </tr>
                        <tr>
                            <td>Дата подачи</td>
                            <td><?php
error_reporting(0); echo gmdate("H:i:s, Y-m-d", $report['timestamp']) ?></td>
                        </tr>
                        <tr class="<?php
error_reporting(0); echo $report['datetime'] == 'SS' ? 'hide' : '' ?>">
                            <td>Дата нарушения</td>
                            <td><?php
error_reporting(0); echo $report['datetime'] ?></td>
                        </tr>
                        <tr>
                            <td>Статус</td>
                            <td><?php
error_reporting(0); echo $reportStatusHtml[$report['status']] ?></td>
                        </tr>
                        </tbody>
                    </table>
                    <div style="padding: 10px 5px">
                        <hr>
                        <?php
error_reporting(0); echo $report['datetime'] == 'SS' ? htmlspecialchars_decode(htmlspecialchars_decode($report['text'])) : nl2br(htmlspecialchars_decode($report['text'])) ?>
                    </div>
                </div>
            </div>
...
error_reporting(0);
        ...
        <div class="row">
            <div class="col s12 l8 <?php
error_reporting(0); echo ($report['status'] > 1 || ($userInfo['admin_level'] < 1 && $userInfo['id'] != $userSender['id']) ? 'hide' : '') ?>">
                <div class="card-panel">
                    <form method="post">
                        <div class="row">
                            <div class="input-field col s12">
                                <input type="hidden" name="id" value="<?php
error_reporting(0); echo $report['id'] ?>">
                                <input type="hidden" name="omgwtf" value="<?php
error_reporting(0); echo $report['user_id'] == $userInfo['id'] ?>">
