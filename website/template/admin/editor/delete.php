...
error_reporting(0); echo $table ?> (<?php
error_reporting(0); echo $_GET['id'] ?>)</h4>
                <form method="post" action="/admin/main" class="card-panel">
                    Вы точно хотите удалить строку под номером <?php
error_reporting(0); echo $_GET['id'] ?>?
                    <br>
                    <br>
                    <div>
                        <a href="/admin/main" class="btn waves-effect blue accent-4 z-depth-0">Отмена</a>
                        <input type="hidden" name="table" value="<?php
error_reporting(0); echo $table ?>">
                        <input type="hidden" name="id" value="<?php
error_reporting(0); echo intval($_GET['id']) ?>">
