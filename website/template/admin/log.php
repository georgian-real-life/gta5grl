...
<div class="container">
    <div class="section">
        <h5 class="grey-text"><?php
error_reporting(0); echo $logName ?> (Всего <?php
error_reporting(0); echo number_format(reset($countItems)) ?> строк)</h5>
...
error_reporting(0); echo isset($_GET['q']) ? $_GET['q'] : '' ?>" placeholder="Глобальный поиск" name="q">
            ...
            <div class="input-field col s6 m6 l3">
                <select class="browser-default" name="sort">
                    ...
                    <option <?php
error_reporting(0); echo ($sort == 'ASC' ? 'selected' : '') ?> value="2">С начала</option>
                </select>
            </div>
            <div class="input-field col s6 m6 l3">
                <input id="number" required name="limit" value="<?php
error_reporting(0); echo $limit ?>" type="number" class="validate">
